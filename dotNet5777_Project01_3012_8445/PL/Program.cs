...
namespace PL
{
    public partial class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                // Employee
                bl.addEmployee(new Employee { Id = "208833012", firstName = "Avi", lastName = "Cohen", phoneNumber = "0536582322", experience = 8, city = "Jerusalem", employeeSpecialization = Enums.job.dataBase, hoursPerMonth = 120, dateBirth = new DateTime(1990, 05, 01), details = new BankAccount(1, "Leumi", 100, "11 Jaffa street", "Jerusalem", 1000),d = Enums.degree.BA });
                bl.addEmployee(new Employee { Id = "303097117", firstName = "Moshe", lastName = "Levi", phoneNumber = "0543906754", experience = 30, city = "Jerusalem", employeeSpecialization = Enums.job.dataSecurity, hoursPerMonth = 130, dateBirth = new DateTime(1967, 08, 06), details = new BankAccount(1, "Pagy", 400, "44 Shaul street", "Jerusalem", 4000) ,d = Enums.degree.diploma});
                ...
                // Specialization
                Specialization s1 = new Specialization { name = Enums.job.communication, minCost = 100, maxCost = 150, minHours = 50, };
                Specialization s2 = new Specialization { name = Enums.job.dataBase, minCost = 35, maxCost = 68, minHours = 80 };
                ...
                // Contract
                bl.addContract(new Contract { beginning = DateTime.Now, final = new DateTime(2020, 09, 03), EmployeeId = "208833012", EmployerId = "205374507", brutoSalary = 15000, numberOfHours = 120, SpecializationNumber = s1.number });
                bl.addContract(new Contract { beginning = DateTime.Now, final = new DateTime(2018, 06, 11), EmployeeId = "303097117", EmployerId = "068340090", brutoSalary = 10000,numberOfHours = 150 ,SpecializationNumber = s2.number });
            ...
            var group3 = bl.ContractsByMonthProfit(false);
